    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Baverages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Baverages_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BavarageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaverageIngredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaverageIngredients_Baverages_BavarageId",
                        column: x => x.BavarageId,
                        principalTable: "Baverages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BaverageIngredients_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BavIngSizeId = table.Column<int>(type: "int", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaverageIngredients_BavarageId",
                table: "BaverageIngredients",
                column: "BavarageId");

            migrationBuilder.CreateIndex(
                name: "IX_BaverageIngredients_IngredientId",
                table: "BaverageIngredients",
                column: "IngredientId");
